...
select models.year, models.name, models.model_id, awards.name from models left join awards on awards.winner_id = models.model_id where models.year > 1963;
...
select b.name, m.name, m.year, b.discontinued, b.discontinued-m.year from models as m left join brands as b on m.brand_id = b.brand_id where discontinued is not null order by b.name, m.name, m.year;
